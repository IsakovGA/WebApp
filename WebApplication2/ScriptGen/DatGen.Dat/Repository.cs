...
namespace DatGen.Dat
{
    public class Repository : IRepository
    {
        ...
        private string MALE_NAMES_PATH = HostingEnvironment.MapPath(@"~\App_Data\Files\MaleNames.txt");
        private string FEMALE_NAMES_PATH = HostingEnvironment.MapPath(@"~\App_Data\Files\FemaleNames.txt");
        private string SURNAMES_PATH = HostingEnvironment.MapPath(@"~\App_Data\Files\surnames.txt");
        private string PATRONYMIC_PATH = HostingEnvironment.MapPath(@"~\App_Data\Files\patronymic.txt");
        private string ENGLISH_WORD_PATH = HostingEnvironment.MapPath(@"~\App_Data\Files\EnglishWord.txt");
